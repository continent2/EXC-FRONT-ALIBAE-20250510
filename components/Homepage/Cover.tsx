...
import HeroAnimatedBanner from './HeroAnimatedBanner'
      ...
      {parseInt(landing?.landing_first_section_status) === 1 && (
        <section className="tradex-bg-background-primary tradex-min-h-[660px] tradex-relative">
          ...
          <img
            ...
            alt=""
          />
          <div className=" tradex-container tradex-pt-8 md:tradex-pt-[80px] tradex-pb-20 tradex-flex tradex-flex-col lg:tradex-flex-row tradex-items-center tradex-relative tradex-z-10 tradex-gap-6 md:tradex-gap-0">
