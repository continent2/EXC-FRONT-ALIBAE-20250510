...
const Navbar = ({
  ...
  return (
    <>
      {isLoggedIn ? (
        <>
          <div className="font-rubik cp-user-top-bar position-fixed !tradex-bg-gradient-to-r !tradex-from-primary-10  !tradex-to-background-primary !tradex-to-40% !tradex-shadow-[2px_2px_32px_0px_#8F8F8F26]">
                ...
                <div className="d-flex align-items-center gap-20">
                  ...
                  <nav className="main-menu">
                    <ul>
                      ...
                      <Link href={isLoggedIn ? "/staking" : "/signin"}>
                        <li
                          className={
                        ...
                        >
                          <Link href="/staking">
                            <a>
                              <span className={`cp-user-name !tradex-gap-1`}>
                                {t("Staking")}
                                {/* {"Staking"} */}
                              </span>
