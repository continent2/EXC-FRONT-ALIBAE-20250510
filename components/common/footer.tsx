  ...
  return (
    <>
      {customPageData && copyright_text && (
        <footer
          className={`!font-rubik tradex-bg-background-footer tradex-space-y-[80px] tradex-pb-[44px] ${
            isTopPaddingEnable
        ...
        >
              ...
              <div className="xl:tradex-col-span-9 tradex-grid md:tradex-grid-cols-2 xl:tradex-grid-cols-4 tradex-gap-5 lg:tradex-gap-10">
                <div className=" tradex-space-y-3 lg:tradex-space-y-10">
                  <div className=" tradex-flex tradex-items-center tradex-gap-2">
                    <h4 className=" tradex-text-sm tradex-font-medium !tradex-capitalize !tradex-text-white font-rubik ">
                          ...
                          <div key={index}>
                            {item.page_type === CUSTOM_PAGE_LINK_PAGE ? (
                              ...
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className=" tradex-text-sm !tradex-text-white "
                              >
                                {item.title}
                              </a>
                            )}
                      ...
                      socialData?.map((social: any, index: any) => (
                        ...
                        >
                          <img
                            ...
                            width={22}
                            className="tradex-rounded-full tradex-border tradex-border-white tradex-object-cover tradex-object-center"
                          />
                        </a>
                      ))
          ...
          <div className="font-rubik tradex-container tradex-pt-6 tradex-border-t tradex-border-[#D9D9D9]/50">
            <div className="tradex-flex tradex-flex-col md:tradex-flex-row tradex-justify-between tradex-items-center tradex-py-4 tradex-text-sm tradex-text-white">
          ...
          {/* <div className="tradex-container tradex-pt-6 tradex-border-t tradex-border-[#D9D9D9]/50 tradex-flex tradex-justify-center">
            <p className=" tradex-text-sm tradex-leading-[30px]  tradex-text-white">
              {(copyright_text && copyright_text) || t("Copyright@2022")}{" "}
