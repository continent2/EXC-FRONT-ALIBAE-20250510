...
{/********* SOCIAL */}
{/** <Link href="/signin"><a><u><b>Social Login</b></u></a></Link> */}
<Link href="/signin"><a><u>Social Login</u></a></Link>
{/** <img src="/social-google.png"  style={{width:'20px',height:"20px"}} alt="" />
<img src="/social-facebook.webp" style={{width:'20px',height:"20px"}}  alt="" />
<img src="/social-apple.png" style={{width:'20px',height:"20px"}}  alt="" />
<img src="/social-instagram.jpg" style={{width:'20px',height:"20px"}}  alt="" /> */}

{/** <div className="mt-3 d-flex justify-content-center align-items-center gap-10">
<img src="/social-google.png"   alt="" />
<img src="/social-facebook.webp"   alt="" />
<img src="/social-apple.png"   alt="" />
<img src="/social-instagram.jpg"   alt="" />
</div>*/}
                  ...
                  <div>
                    { true || (settings.social_login_google_enable == 1 ||
                      ...
                      settings.social_login_enable && (
                        <div className="mt-5">
                          ...
                          <div className="mt-3 d-flex justify-content-center align-items-center gap-10">
                            ...
                            { (true || settings.social_login_facebook_enable == 1 ) && (
                              <FacebookLogin
                            ...
                            { ( true || settings.social_login_apple_enable == 1 ) && (
                              <AppleSignin
                                authOptions={{
